...
function sharePointReady() {
    ...
    properties.set_item("BING_MAPS_KEY", "ApqzNRu0mn1Li2ngnD2x-ZCwalMB0m1IavSP5tcINeZRQ7feN1uppjEt-GpSPLiN");
    alert('3');
    context.load(web);
    alert('4');
    context.executeQueryAsync(onSetmapkeySuccess, onSetmapkeyFail);
    ...
    */
    ...
    web.AllProperties["BING_MAPS_KEY"] = "ApqzNRu0mn1Li2ngnD2x-ZCwalMB0m1IavSP5tcINeZRQ7feN1uppjEt-GpSPLiN";
    web.Update();
    context.executeQueryAsync(onSetmapkeySuccess, onSetmapkeyFail);
    */
